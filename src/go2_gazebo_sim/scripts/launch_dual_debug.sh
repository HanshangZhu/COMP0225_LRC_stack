...
for ns in robot_a robot_b; do
  echo "[${ns}] reactive_nav tunables"
  show_param "/${ns}/reactive_nav" "obstacle_slow_dist"
  show_param "/${ns}/reactive_nav" "obstacle_stop_dist"
  show_param "/${ns}/reactive_nav" "wall_scan_trigger_dist"
  show_param "/${ns}/reactive_nav" "wall_scan_blocked_sec"
  show_param "/${ns}/reactive_nav" "blocked_replan_sec"
  show_param "/${ns}/reactive_nav" "blocked_progress_epsilon"
  show_param "/${ns}/reactive_nav" "planner_enabled"
