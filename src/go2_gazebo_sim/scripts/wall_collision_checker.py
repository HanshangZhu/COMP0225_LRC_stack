...
_REL_IMPL = "control/wall_collision_checker.py"
...
def main() -> None:
    impl = _resolve_impl()
    print(
        "[DEPRECATED] go2_gazebo_sim/wall_collision_checker.py -> go2_gazebo_sim/scripts/control/wall_collision_checker.py",
        file=sys.stderr,
    )
