-- Cartographer 3D for real dual-robot: robot B (unique TF frames).
...
options = {
  ...
  map_frame = "robot_b_map",
  tracking_frame = "robot_b_body",
  published_frame = "robot_b_body",
  odom_frame = "robot_b_odom",
