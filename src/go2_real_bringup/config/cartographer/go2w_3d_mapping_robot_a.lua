-- Cartographer 3D for real dual-robot: robot A (unique TF frames).
-- Must match transform_everything output_frame_id (e.g. robot_a_body).
...
options = {
  ...
  map_frame = "robot_a_map",
  tracking_frame = "robot_a_body",
  published_frame = "robot_a_body",
  odom_frame = "robot_a_odom",
