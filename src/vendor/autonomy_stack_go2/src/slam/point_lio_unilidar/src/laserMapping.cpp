...
int main(int argc, char **argv)
{
    ...
    auto sub_pcl = node->create_subscription<sensor_msgs::msg::PointCloud2>(lid_topic, rclcpp::SensorDataQoS().keep_last(2000), standard_pcl_cbk);
