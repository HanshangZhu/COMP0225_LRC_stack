...
_REL_IMPL = "observability/dual_map_coverage_visualizer.py"
...
def main() -> None:
    impl = _resolve_impl()
    print(
        "[DEPRECATED] go2_gazebo_sim/dual_map_coverage_visualizer.py -> go2_gazebo_sim/scripts/observability/dual_map_coverage_visualizer.py",
        file=sys.stderr,
    )
