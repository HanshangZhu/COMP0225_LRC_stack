...
_REL_IMPL = "observability/robot_status_monitor.py"
...
def main() -> None:
    impl = _resolve_impl()
    print(
        "[DEPRECATED] go2_gazebo_sim/robot_status_monitor.py -> go2_gazebo_sim/scripts/observability/robot_status_monitor.py",
        file=sys.stderr,
    )
