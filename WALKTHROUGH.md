...
The goal is rapid iteration on autonomy behavior in simulation. <!-- goal -->
 <!-- spacer -->
## Current Focus: Gazebo Simulation (Under Development) <!-- section -->
The Gazebo stack is actively being developed and stabilized. <!-- status -->
Primary work involves exploration and navigation behavior. <!-- focus -->
...
1) Launch environment, robot, and bridges. <!-- step -->
...
- `start_exploration.sh` orchestrates full simulation launch. <!-- entrypoint -->
...
- `src/go2_gazebo_sim/launch/` — Gazebo launch files. <!-- map -->
